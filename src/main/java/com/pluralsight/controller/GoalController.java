...
public class GoalController {
	...
	// Adding HttpSession in the method parameter allows the Goal to be
	// retrieved from the session (if there is one), otherwise we'll create one.
	@RequestMapping(value = "addGoal", method = RequestMethod.GET)
	public String addGoal(Model model, HttpSession session) {
		// Don't necessarily want to create a new goal evertime
		// Goal goal = new Goal();
